...
# Script Variables
assets = os.path.join(root_dir, "assets", "templates", "testlstick")
...
def program(settings):
	...
	from gamepad import Gamepad
	GAMEPAD = Gamepad()
	GAMEPAD.move_left_stick(hold_time, "N")
	GAMEPAD.move_left_stick(hold_time, "E")
	GAMEPAD.move_left_stick(hold_time, "S")
	GAMEPAD.move_left_stick(hold_time, "W")
